...
public class OrderDetailsDAOImpl implements OrderDetailDAO {
    ...
    public boolean save(OrderDetails details) throws SQLException, ClassNotFoundException {
        return SqlUtil.execute("INSERT INTO order_details VALUES(?,?,?,?,?,?)", details.getOrderId(), details.getCode(), details.getQty(), details.getUnitPrice(), details.getService_charge(), details.getTotal());
    }
